...
//
//	mockgen -destination=internal/mocks/user/mock_repository.go -package=user github.com/RomanAgaltsev/ya_gophermart/internal/app/gophermart/service/user Repository
//
